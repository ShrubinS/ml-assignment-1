...
DATA_SETS = {
	...
	# 'sum_with_noise' : DATASET_ROOT + '/The SUM dataset, without noise.csv',
	#'kc_house_data'	: DATASET_ROOT + '/kc_house_data.csv',
   'skinnonskin'	: DATASET_ROOT + '/Skin_NonSkin.txt',
    # 'susy'          : DATASET_ROOT + '/SUSY.csv/SUSY.csv',
